    ...
    <div class="w3-third">
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        ...
        <div class="w3-container">
          ...
          <!-- отображение навыков -->
          <?php
            for($i=0; $i < count($mySkills['skillName']); $i++)
            { 
            ?>
              <p><?php echo $mySkills['skillName'][$i]; ?></p>
              <div class="w3-light-grey w3-round-xlarge w3-small">
              <div class="w3-container w3-center w3-round-xlarge w3-teal" style="width: <?php echo $mySkills['skillLevel'][$i]; ?>%"><?php echo $mySkills['skillLevel'][$i]; ?>%</div>
              </div>
